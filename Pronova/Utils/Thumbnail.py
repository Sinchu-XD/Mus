...
async def get_thumb(title, duration, thumbnail, channel=None, views=None, videoid=None):
    try:
        ...
        try:
            title_font = ImageFont.truetype("NotoSansDevanagari-Bold.ttf", 52)
        except:
            try:
        ...
        label_font = ImageFont.truetype("Cinzel-Black.ttf", 42)
        ...
        # Artist / Channel Name (bigger and clearer)
        artist_y = title_y + 150
        artist_text = f"{channel}"

        channel_font = ImageFont.truetype("font.ttf", 36)
